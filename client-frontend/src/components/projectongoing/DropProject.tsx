...
interface DropProjectProps {
  project: any;
  onClose: () => void;
  onConfirmDrop: (id: string, amount: string) => void;
        ...
        <div className="p-6 text-center space-y-4">
          ...
          <div>
            <h3 className="text-base font-bold text-slate-900 font-serif">
              Drop Ongoing Project Confirmation
            </h3>
            <p className="text-xs text-slate-600 mt-2 leading-relaxed">
              If you want to drop this ongoing project, you need to pay your project{" "}
              <strong className="text-slate-900">{feePercentage}% {feeLabel}</strong> before Drop.
            </p>
          </div>
          ...
          <div className="bg-blue-50/60 border border-blue-100 rounded-xl p-4 text-left space-y-2">
            ...
            <div className="pt-2 border-t border-blue-200/60 flex justify-between text-xs font-bold text-blue-900">
              <span>{feePercentage}% {feeLabel} Payable:</span>
              <span className="font-serif text-sm text-blue-600 font-bold">{formattedFee}</span>
            </div>
          </div>
